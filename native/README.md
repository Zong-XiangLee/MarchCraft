...
- Regulation front/back field layout inside an editable eight-step staging apron, with yard numbers, corrected HS/NCAA/NFL hashes, five-yard lines, and exactly four vertical one-yard inserts per five-yard interval
