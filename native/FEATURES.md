...
| 3D | Meter-based Y-up world; grounded skinned human performers with a marching attention stance (closed heels, 45-degree toe angle, elevated head, neutral stacked torso, and centered hand set), path-aware straight-leg forward technique, forefoot backward technique, progressively twisted slides, turns, and three LODs; body-rig, skin, and future equipment socket attributes; configurable rehearsal/stadium/gym/arena environments; lighting and quality presets; props; press-box, overhead, and field cameras; ground-contact diagnostics |
