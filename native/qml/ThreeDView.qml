...
Item {
    ...
    readonly property int cameraDuration: !root.exportMode && cameraReady && workspaceController.systemAnimationsEnabled
    ...
    View3D {
        ...
        Model {
            ...
            scale: Qt.vector3d(1.6, root.projectModel.fieldDepthSteps / 100, 1)
            materials: PrincipledMaterial {
                roughness: root.projectModel.fieldPreset === "indoor" ? 0.65 : 0.98
                baseColorMap: Texture {
                    ...
                    sourceItem: Canvas {
                        ...
                        onPaint: {
                            ...
                            const indoor = root.projectModel.fieldPreset === "indoor"
                            ctx.fillStyle = indoor ? "#b98b58" : root.projectModel.turfColor
