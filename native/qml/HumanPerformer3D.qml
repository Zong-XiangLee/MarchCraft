...
Node {
    ...
    property real gaitElapsedCounts: transitionProgress * Math.max(1, countsInMove)
    ...
    readonly property real strideMeters: Math.min(0.70, Math.max(0,
        travelStepsPerCount * metersPerStep * canonicalHeight / heightMeters))
    ...
    readonly property bool markTime: locomotionMode === "mark_time"
    // The canonical -Z-forward rig becomes audience-facing after its 180° turn.
    // Therefore a field-right slide travels toward canonical -X.
    readonly property real relativeTravelDegrees: HumanGait.normalizeDegrees(facingDegrees - travelHeading)
    readonly property real elapsedCounts: gaitElapsedCounts
    ...
    readonly property real closingWeight: closingTransition && marching
                                          ? HumanGait.clamp(transitionProgress * countsInMove - Math.max(0, countsInMove - 1), 0, 1)
                                          : 0
    readonly property var rawBodyPose: directionChange || markTime
    ...
    readonly property var rawLeftLegPose: markTime
                                       ? HumanGait.markTimeLegPose(gaitPhase, true, motionWeight)
                                       : directionChange
    ...
    readonly property var rawRightLegPose: markTime
                                        ? HumanGait.markTimeLegPose(gaitPhase, false, motionWeight)
                                        : directionChange
                                        ...
                                        : HumanGait.directionalLegPose(relativeTravelDegrees, gaitPhase, false,
                                                                       strideMeters, motionWeight, bodyPose)
    readonly property bool closingLeftSide: Math.round(elapsedCounts + (1 - transitionProgress) * countsInMove) % 2 !== 0
    ...
    readonly property var poseJoints: [
    ...
    Node {
        ...
        Node {
            ...
            Node {
                ...
                rotation: HumanGait.rotationXYZ(0,
                    ...
                    Node {
                        ...
                        rotation: HumanGait.rotationXYZ(root.bodyPose.spinePitch,
                                                   root.bodyPose.spineYaw * 0.50,
                                                   root.bodyPose.spineRoll * 0.45)
                        Node {
                            id: spineUpper
                            y: 0.23
                            rotation: HumanGait.rotationXYZ(-root.bodyPose.spinePitch * 0.62,
                                                       root.bodyPose.spineYaw * 0.50,
                            ...
                            Node {
                                ...
                                Node {
                                    id: upperArmLeft
                                    x: -0.11; y: -0.03
                                    rotation: HumanGait.carriageRotation(root.leftArmPose.upperX,
                                                               root.leftArmPose.upperY,
                                                               root.leftArmPose.upperZ, root.carriagePose === "horn.down")
                                    Node {
                                        id: forearmLeft
                                        x: -0.24; y: -0.19
                                        rotation: HumanGait.rotationXYZ(root.leftArmPose.forearmX,
                                                                   root.leftArmPose.forearmY,
                                                                   root.leftArmPose.forearmZ)
                                        Node {
                                            id: handLeft
                                            x: -0.23; y: -0.14
                                            rotation: HumanGait.rotationXYZ(root.leftArmPose.handX,
                            ...
                            Node {
                                ...
                                Node {
                                    id: upperArmRight
                                    x: 0.11; y: -0.03
                                    rotation: HumanGait.carriageRotation(root.rightArmPose.upperX,
                                                               root.rightArmPose.upperY,
                                                               root.rightArmPose.upperZ, root.carriagePose === "horn.down")
                                    Node {
                                        id: forearmRight
                                        x: 0.24; y: -0.19
                                        rotation: HumanGait.rotationXYZ(root.rightArmPose.forearmX,
                                                                   root.rightArmPose.forearmY,
                                                                   root.rightArmPose.forearmZ)
                                        Node {
                                            id: handRight
                                            x: 0.23; y: -0.14
                                            rotation: HumanGait.rotationXYZ(root.rightArmPose.handX,
                    ...
                    Node {
                        id: thighLeft
                        x: -0.105; y: -0.03
                        rotation: HumanGait.rotationXYZ(root.leftLegPose.hipX, 0, root.leftLegPose.hipZ)
                        Node {
                            id: shinLeft
                            y: -0.39
                            rotation: HumanGait.rotationXYZ(root.leftLegPose.kneeX, 0, root.leftLegPose.kneeZ)
                            Node {
                                id: footLeft
                                y: -0.415
                                rotation: HumanGait.rotationXYZ(root.leftLegPose.footX,
                    ...
                    Node {
                        id: thighRight
                        x: 0.105; y: -0.03
                        rotation: HumanGait.rotationXYZ(root.rightLegPose.hipX, 0, root.rightLegPose.hipZ)
                        Node {
                            id: shinRight
                            y: -0.39
                            rotation: HumanGait.rotationXYZ(root.rightLegPose.kneeX, 0, root.rightLegPose.kneeZ)
                            Node {
                                id: footRight
                                y: -0.415
                                rotation: HumanGait.rotationXYZ(root.rightLegPose.footX,
