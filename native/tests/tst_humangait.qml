...
TestCase {
    ...
    function test_attentionPostureIsTallNeutralAndPerformanceReady() {
        ...
        // Wrist yaw counter-rotates the converging forearms so the fingers
        // point toward the horn. Actual mesh-direction probes live in HumanRig.
        verify(leftArm.handY > 50 && rightArm.handY < -50)
